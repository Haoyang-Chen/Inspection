<template>
  ...
  >
    <el-form :model="form" :rules="rules" ref="form" label-width="120px" class="demo-form">
      <el-row :gutter="24">
        <el-col :span="12">
          <el-form-item label="文件编号：" prop="no">
            <el-input v-model="form.no" placeholder="请输入文件编号" :disabled="!editable"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="文件名称：" prop="title">
            <el-input v-model="form.title" placeholder="请输入文件名称" :disabled="!editable"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
        ...
        <el-col :span="12">
          <el-form-item label="时效性：" prop="status">
            <el-select
              ...
              style="width:100%"
              >
              <el-option v-for="item in secDocStatusOptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="24">
...
import { addSecdoc, updateSecdoc, infoSecdoc } from "@/api/modules/knowledge/securityDoc";
  ...
  methods: {
    ...
    submitForm: function() {
      this.$refs['form'].validate((valid) => {
        if (valid) {
          let opFunc;
          opFunc = this.form.id ? updateSecdoc : addSecdoc;

        ...
        <el-col :span="10">
          ...
          >
            <el-row type="flex" justify="center">
              ...
              <el-col :span="8" class="card-panel" :offset="1">
                <div class="card-panel-text">当日作业票总数</div>
                <count-to
                  :start-val="0"
                  :end-val="drzypzs"
                  :duration="2600"
            ...
            <el-row type="flex" justify="center">
              <el-col :span="8" class="card-panel" :offset="1">
                <div class="card-panel-text">当日巡检点数量</div>
                <count-to
                  :start-val="0"
                  :end-val="drxjds"
                  :duration="2600"
        ...
        <el-col :span="7">
          <div class="frameDiv" :style="{ height: chartConHeight + 'px' }">
            <div class="frame">
              ...
              <div class="chartBg">
                <JobTicketChart ref="JobTicketChart" :height="chartHeight" @sendAllTotal="sendAllTotal" />
              </div>
            </div>
          </div>
          <div class="frameDiv" :style="{ height: chartConHeight + 'px' }">
...
import JobTicketChart from "./dashboard/home/JobTicketChart";

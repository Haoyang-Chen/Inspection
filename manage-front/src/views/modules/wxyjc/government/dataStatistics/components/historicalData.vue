<template>
  <div class="app-container materielHistoricalDataBox">
    ...
    <div
      class="mt20"
      style="height: calc(100vh - 320px); width: 100%; min-height: 400px"
    >
...
<script>
import { HistoricalTrendChart_API } from "@/api/modules/wxyjc/wxyjcdangerousinfo";
    ...
    init() {
      ...
      HistoricalTrendChart_API(params).then((res) => {
        ...
        shebeiData.map((res) => {
          ...
          timeList.push(res.collectTime);
          equipmentList.push(res.m2);

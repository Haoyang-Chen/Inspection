    ...
    <el-row :gutter="20">
      ...
      <el-col :span="24" :xs="24">
        <el-form :model="queryParams" ref="queryForm" :inline="true">
          ...
          <el-form-item label="提交整改日期" prop="reformDate">
            <el-date-picker
              v-model="queryParams.reformDate"
              type="date"
              format="yyyy年MM月dd日"
              value-format="yyyy-MM-dd"
              placeholder="请选择提交整改日期"
              size="small"
              style="width: 180px"
            ></el-date-picker>
          </el-form-item>
        ...
        <el-row :gutter="24" class="mb8">
          <el-col>
            <span class="table-title">隐患复查列表</span>
          </el-col>
        </el-row>
...
import ReviewDialog from "@/views/components/trouble/review-dialog";

export default {
  name: "TroubleReview",
  components: { RegisterForm, PublishForm, ReviewDialog },
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    handleReview(row) {
      this.reviewing = true;
      this.$nextTick(() => {
        this.$refs.reviewDialog.setup(row);
      });
    }
  }
};

 ...
 * 表格时间格式化
 */
export function formatDate(cellValue, showTime = true) {
...
/**
 * 设置默认近 n 天的日期
 * @param {String} datt '2018-07-07'
 * @param {Number} n 
 * @returns 
 */
 export function getBeforeDate(datt, n) {
  datt = datt.split('-');
...
/** 日期范围（单个日期）日期重置 */
export function clearDateRange(params, startParam, endParam) {
  var search = params
  search[startParam] = undefined
  search[endParam] = undefined
  return search
}